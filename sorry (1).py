...
BOT_TOKEN = "7087446727:AAEUjBLm8DEfS9ItMKvgDeoMNu-KI0hLA64"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "Welcome to Spotify Downloader Bot! You can search for a song by typing the album or movie name. 🎶 Created by Lokesh.R"
    )
...
async def select_song(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # Download the song using spotdl (Termux-compatible path)
        command = [
            "/data/data/com.termux/files/usr/bin/spotdl",
            "download",
            track_url
        ]
